...
- you should use the `node` official image, with the alpine 6.x branch dock(`node:6-alpine`)
...
- Then it should use the alpine package manager to install tini: `apk add --no-cache tini`.80
